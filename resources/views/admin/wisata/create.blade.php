...
<head>
    ...
    <title>Tambah Wisata & Jasa - Desa Digital</title>
            ...
            <header class="flex h-20 items-center justify-between border-b border-gray-200 bg-white px-6">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">
                        Tambahkan informasi wisata dan jasa masyarakat desa.
                    </p>
                        ...
                        <div class="border-b border-gray-200 px-6 py-5">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">
                                        Masukkan informasi wisata atau jasa masyarakat.
                                    </p>
